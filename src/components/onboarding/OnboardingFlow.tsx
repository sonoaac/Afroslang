...
export function OnboardingFlow({ onSignIn, onComplete }: OnboardingFlowProps) {
  ...
  const css = `
    ...
    .ob-btn-delayed { animation: ob-fadein 0.35s ease 3s both; pointer-events: none; }
    .ob-btn-delayed.ob-btn-ready { animation: ob-fadein 0.35s ease both; pointer-events: auto; }
    .ob-lang-card {
    ...
    return (
      <Overlay>
        <div className="ob-card" key={animKey} style={cardBg(step)}>
          ...
          <div style={{ flex: 1 }} />
          <div className="ob-bottom ob-btn-delayed" onAnimationEnd={e => (e.currentTarget.style.pointerEvents = 'auto')}>
      ...
      <Overlay>
        <div className="ob-card" key={animKey} style={cardBg(step)}>
          ...
          <StepContent stepKey={animKey} style={{ gap: '1.2rem' }}>
            ...
            <div className="ob-btn-delayed" onAnimationEnd={e => (e.currentTarget.style.pointerEvents = 'auto')} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
              <div style={{
